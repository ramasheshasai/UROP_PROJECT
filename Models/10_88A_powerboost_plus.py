# File: 14_final_clean_ensemble.py
...
base_models = [
    ...
    ExtraTreesClassifier(n_estimators=300, max_depth=6, random_state=42),
...
print("Final Clean Ensemble Accuracy:", acc)
print("\nClassification Report:\n", report)

with open("results/final_clean_ensemble_report.txt", "w") as f:
    f.write(f"Final Clean Ensemble Accuracy: {acc}\n\n")
    f.write(report)
